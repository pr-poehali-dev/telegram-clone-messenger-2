...
import { chats as defaultChats, Chat } from "@/data/mockData";
...
export default function ChatList({ onSelect, selectedId, archived = false, currentNick, extraChats, onGroupCreated }: ChatListProps) {
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-0.5">
                  <div className="flex items-center gap-1 min-w-0">
                    {chat.isChannel && (
                      <Icon name="Megaphone" size={11} style={{ color: "#ef4444", flexShrink: 0 } as React.CSSProperties} />
                    )}
